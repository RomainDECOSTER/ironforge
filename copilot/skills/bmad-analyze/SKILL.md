...
description: >
  ...
  Delegates to the appropriate BMAD agent for each phase. Each phase requires explicit user validation
...
Use the BMAD PM agent to complete this phase.
...
Use the BMAD architect agent and the engineering-software-architect agent to complete this phase.
